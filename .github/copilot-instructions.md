...
**Key files:** `src/app/articles/articles.registry.ts`, `src/app/utils/frontmatter.parser.ts`, `src/app/resolvers/article.resolver.ts`, `src/app/components/article-loader-component/article-loader.component.ts`
